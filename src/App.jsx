...
function App() {
  ...
  return (
    <>
      ...
      <div className='sm:flex sm:flex-col xl:flex-row mt-10 gap-16 mx-10'>
        {/* Columna izquierda */}
        <div className='w-[100%] sm:w-[100%] xl:w-[50%] flex flex-col justify-center items-center gap-4'>

          {/* Imagen grande */}
          <div className='flex gap-4 px-4'>
            <div className="w-full overflow-hidden shadow-md shadow-gray-400 rounded-3xl border border-gray-300">
              <img className=' w-full h-full object-cover '
                src={feria5}
                alt=""
              />
            </div>
            <div className="w-[50%] sm:w-[50%] xl:w-auto overflow-hidden shadow-md shadow-gray-400 rounded-3xl border border-gray-300">
              <img className=' w-full h-full object-cover'
                src={feria1}
                alt=""
              />
          ...
          <div className='flex gap-4 px-4'>
            <div className="w-[50%] sm:w-[50%] xl:w-[90%] overflow-hidden shadow-md shadow-gray-400 rounded-3xl border border-gray-300">
              <img className='w-full h-full object-cover'
                src={feria3}
                alt=""
              />
...
export default App
{/* <div className='flex justify-around mx-10 mt-40 gap-16'>
        <div>
          <img src="https://agroexpo.com/img/logo-pulzo.png" alt="" />
        </div>
        <div>
          <img src="https://agroexpo.com/img/logo-pulzo.png" alt="" />
        </div>
