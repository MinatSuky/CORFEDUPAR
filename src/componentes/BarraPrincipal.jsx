    ...
    <div className='flex flex-col'>
      ...
      <div className='bg-base-verde-oscuro w-full flex top-[115px] lg:top-[135px] shadow-2xl fixed z-10 justify-around items-center'>
        <div className='redes-sociales flex items-center gap-2'>
          <a href='https://www.facebook.com/corfedupar.feriaganadera/' className='border w-full border-white rounded-full py-1 px-1 my-3 shadoow'>
          ...
          <a href='https://www.instagram.com/corfedupar_oficial/' className='border border-white rounded-full py-1 px-1 my-3 shadoow'>
