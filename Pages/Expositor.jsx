    ...
    <div>
      ...
      <BarraPrincipal />
            ...
            <div className=' mx-5 lg:mx-20 mt-20 mb-30 lg:mb-70'>
                <p className='feria font-bold lg:text-5xl text-[#015811]'>Perfil del expositor</p>
                <div className='flex flex-col lg:flex-row gap-5 items-center mt-10'>
                    <div className='w-full lg:w-[50%]'>
                        <p className='lg:text-xl'><span className='font-bold'>¡Vive la experiencia CORFEDUPAR!</span> <br />
