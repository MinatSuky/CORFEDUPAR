...
const Home = () => {
  return (
    <div>
      <BarraPrincipal />
      {/* --------- sesion #1 ---------- */}
      <div className='w-[100%] flex flex-col mt-[190px] items-center justify-end relative'>
       ...
       <Link to={'/Valores'}> <button className='absolute cursor-pointer items-center text-[10px] md:text-[14px] flex gap-3 md:bottom-[5%] bottom-[2%] rounded-xl px-5 py-1 md:px-10 md:py-3 left-[41%] shadow-2xl text-shado md:left-[24%] bg-base-naranja text-white feria font-bold'>CONSULTA VALORES <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512"><path fill="#ffffff" fill-rule="evenodd" d="M213.304 128h42.654V42.667h-42.654zM42.688 256h85.308v-42.666H42.688zm101.466-81.674L83.84 113.974l30.156-30.166l60.313 60.352zm-30.159 211.187l-30.156-30.165l60.312-60.352l30.157 30.165zM325.12 174.326l-30.157-30.166l60.313-60.352l30.157 30.166zM270.933 464l-80.707-273.873L464 270.934l-62.72 62.72l59.733 59.52l-67.84 67.84l-59.52-59.734z"/></svg></span></button></Link>
      </div>
      {/* --------- sesion #2 ---------- */}
