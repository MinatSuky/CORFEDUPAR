  ...
  return (
    <div>
      ...
      <div className='w-[100%] flex flex-col mt-[170px] lg:mt-[190px] items-center justify-end relative'>
        <img className=' object-cover shadow-2xl hidden md:flex' width={2000} height={500} loading="lazy" src={plaza} alt="" />
        <img className=' object-cover shadow-2xl flex md:hidden' width={412} height={459} loading="lazy" src={MobileSesion1} alt="" />
      ...
      {/* --------- sesion #2 ---------- */}
      <p className='text-base-verde lg:text-4xl font-bold text-center mt-16'>¿QUIÉNES SOMOS?</p>
      <Sesion2 />
      {/* --------- sesion #3 ---------- */}
      <Sesion3 />
      {/* --------- sesion #4 ---------- */}
